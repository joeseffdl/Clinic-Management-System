<template>
  <q-page class="bg-accent" style="font-family: Source Sans Pro">
    <div class="container">
      <!-- Section 1 -->
        ...
        <div class="col">
          ...
          <div class="row justify-start">
            <h4 >
              ...
              Aenean sed eleifend mi, nec iaculis leo. Nulla facilisi. 
      ...
      <!-- Section 3 -->
      <section class="section-3 row justify-center">
        <div class="col">
          <q-carousel
            v-model="slide"
