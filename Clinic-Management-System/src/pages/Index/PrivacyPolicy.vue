  ...
  <q-page class="bg-secondary">
   <div class="container column">
    ...
    <section>
      ...
      <br />
      <p class="text-grey text-center">LAST UPDATED: MARCH 2022</p>
      <h5>GENERAL TERMS</h5>
      <br />
    ...
    <!-- Section 2 -->
    <section id="interpretation-definition">
      ...
      <ul>
          ...
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Best Byte.</li>
          ...
          <li><strong>Website</strong> refers to Best Byte, accessible from <a href="http://www.bestbyte.com">http://www.bestbyte.com</a></li>
    ...
    <!-- Section 4 -->
    <section id="use-personal-data">
      <h5>USAGE OF YOUR PERSONAL DATA</h5>
      <br />
    ...
    <!-- Section 5 -->
    <section id="retention-personal-data">
    ...
    <!-- Section 6 -->
    <section id="transfer-personal-data">
    ...
    <!-- Section 8 -->
    <section id="security-personal-data">
    ...
    <!-- Section 9 -->
    <section id="changes-privacy-policy">
    ...
    <section id="contact-us">
        ...
        <ul>
            <li>By email: bestbyte@gmail.com</li>
            <li>By visiting this page on our website: <a href="http://www.bestbyte.com/contact">http://www.bestbyte.com/contact</a></li>
        </ul>
    </section>
   </div>
  </q-page>
