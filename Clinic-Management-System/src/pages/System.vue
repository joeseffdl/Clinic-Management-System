      ...
      <div class="row ">
        <div class="col-10 q-mx-auto" >
          ...
          <div class="row q-gutter-md q-px-auto" >
            <div v-for="(name, index) in patientName"  :key="index" class="col-auto" > 
              <q-card v-if="show" flat bordered class="my-card bg-primary" style="width: 100%; max-width: 250px;">
                <q-card-section>
                  <div class="row">
                    <div  class="col ">
                ...
                <q-card-actions class="justify-around">
                  <q-btn flat round color="red" icon="mdi-close" @click="removeItem(index)" />
